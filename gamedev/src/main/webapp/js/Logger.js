    ...
    var self =
    {
        ...
        init: function()
        {
            ...
            if(!containerDiv)
            {
                ...
                tabDiv.id = TAB_DIV;
                tabDiv.appendChild(document.createTextNode("System Log"));
                tabDiv.setAttribute("style", "width:90px; " +
                                             "box-sizing:border-box; " +
                                             "overflow:hidden; " +
                ...
                span.style.color = "#9bccee";
                span.style.fontWeight = "bold";

                // the first message in log
                var msg = "System Log " + getDate() + " " + getTime();
        ...
        print: function(msg)
        {
            ...
            for(var i in lines)
            {
                ...
                if(!msgDefined)
                    msgDiv.style.color = "#0093f9"; // override color if msg is not defined

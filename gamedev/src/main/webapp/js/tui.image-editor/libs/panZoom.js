...
function IEditorPanZoom(editor) {
    ...
    this.enable = function(p_editorSelector) {
    	editorSelector = p_editorSelector;
        
        scrollContainer = $(editorSelector).find('.tui-image-editor-wrap');
        editorContainer = $(editorSelector).find('.tui-image-editor')[0];
        ...
        $(editorSelector).find('.tui-image-editor-wrap')[0].onwheel = function() { return false; };
    ...
    function scaleCanvas(zoomIn, wDelta, e) {
        ...
        //var imageEditorWindow = $(editorSelector).find('#tui-image-editor-container .tui-image-editor')[0];
        var imageEditorWindow = $(editorSelector).find('.tui-image-editor')[0];
    ...
    function onMousewheel(e){
        var imageOriginalSize = {
          ...
          var imageEditorWindow = e.currentTarget;
          var scrollContainer = $(editorSelector).find('.tui-image-editor-wrap');
          var initWidth = imageEditorWindow.style.width;
          var initHeight = imageEditorWindow.style.height;
          var scrollContainerInitial = {
            top: scrollContainer.scrollTop(),

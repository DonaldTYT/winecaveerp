...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var isNoScriptElement = function (node) { return node.tagName === 'NOSCRIPT'; };
    ...
    var CanvasRenderer = /** @class */ (function (_super) {
        ...
        CanvasRenderer.prototype.renderTextWithLetterSpacing = function (text, letterSpacing, baseline) {
            ...
            if (letterSpacing === 0) {
                ...
                //try to fix baseline bug
                var tm = _this.ctx.measureText(text.text);
                //console.log('fontBoundingBoxAscent', 'baseline:' + baseline + ',fontBoundingBoxAscent:' + tm.fontBoundingBoxAscent);
                this.ctx.fillText(text.text, text.bounds.left, text.bounds.top + 
                					(typeof(tm.fontBoundingBoxAscent) != 'undefined' ? tm.fontBoundingBoxAscent : baseline));
            }
            else {

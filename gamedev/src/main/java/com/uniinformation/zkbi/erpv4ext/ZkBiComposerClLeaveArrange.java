...
public class ZkBiComposerClLeaveArrange extends ZkBiComposerBase {

	@Override
	public void doAfterCompose(Component p_comp) throws Exception {
		super.doAfterCompose(p_comp);
		UniLog.log1("doAfterCompose called");
		masterWin.addEventListener("onHideButtonCllArr", new EventListener<Event>() {
			@Override
		...
		Events.echoEvent("onHideButtonCllArr", masterWin, null);
	}
}

...
import com.uniinformation.bicore.wc.BiResultCreateProduct;
import com.uniinformation.bicore.wc.BiResultStmdMI;
import com.uniinformation.jxapp.JxZkBiFastCreate;
import com.uniinformation.jxapp.JxZkBiBase;

public class CreateProduct extends JxZkBiBase {
	@Override
	public void bindCellCollection(BiResult br, int mode) {
		super.bindCellCollection(br, mode);
		if(!(br instanceof BiResultCreateProduct)) return;
		BiResultCreateProduct sr = (BiResultCreateProduct) br;

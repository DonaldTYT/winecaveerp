package com.uniinformation.erpv4.hapyik;
...
public class HapyikPrtdocPrintInvoice extends PrtdocPrintInvoice {
	Vector<BiCellCollection> invList=null;
	public HapyikPrtdocPrintInvoice(BiResultErpv4 p_br, PrtdocJson p_ppj,JSONObject p_option) {

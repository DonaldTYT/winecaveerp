...
public class BiTableClDoctor extends BiTable {

	public BiTableClDoctor(CellCollection parent, String p_tableName, String p_dbtName, String p_eName, String p_cName,
	...
	protected Wherecl getFieldUniqueListAppendWhere(BiField p_fd,SessionHelper p_sh) {
		...
		if(Erpv4Config.isMultiCompany(p_sh)) {
			if(!p_sh.hasAccessRight("#multicomp")) {
				...
				wcl.appendString(" and cldoctor.cldoc_cocode = '"+Erpv4Config.getDefaultCoCode(p_sh)+"'").stripAnd();
			}
		}
		return(wcl);
	}

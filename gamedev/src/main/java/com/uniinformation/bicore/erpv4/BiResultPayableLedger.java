...
public class BiResultPayableLedger extends BiResultArApJournal {
	public BiResultPayableLedger(BiResult p_parent, BiView p_view, SelectUtil p_su, Vector p_tabList,
		...
		Value val =
				rpc.callSegment("erpv4_getApAccountCode",
				new VectorUtil()
				.toVector()
				);

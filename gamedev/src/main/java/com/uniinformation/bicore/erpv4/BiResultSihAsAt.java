...
public class BiResultSihAsAt extends BiResultAgingAsAt{

	public BiResultSihAsAt(BiResult p_parent, BiView p_view, SelectUtil p_su, Vector p_tabList, String p_whereStr,

...
public class BiResultProfitLedger2 extends BiResultLedger  {

	public BiResultProfitLedger2(BiResult p_parent, BiView p_view, SelectUtil p_su, Vector p_tabList, String p_whereStr,
	...
	protected void setRunningBalance(int idx, LedgerCostCalculator ca) throws Exception {
		...
		*/
		double amt = getCellDouble("stmd_cost");
		double lamt = getCellDouble("stmd_exprice");
	...
	protected BiColumn getCumulatorKey() {
		// TODO Auto-generated method stub
		return(getColumnByLabel("stmd_plkey"));
	}

...
public class BiResultProfitLedger extends BiResultLedger  {

	public BiResultProfitLedger(BiResult p_parent, BiView p_view, SelectUtil p_su, Vector p_tabList, String p_whereStr,
	...
	enum FuncName { FUNC_getUnRealizedQty,FUNC_getUnRealizedAmount,
					NOT_DEFINED }

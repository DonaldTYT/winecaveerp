...
public class PBEFileProcessor
{
        ...
        throws Exception
    {
        ...
        String outFileName = fileName + ".asc";
        String passphase = "abc123";
        boolean integrityCheckFlag = true;
        boolean armorFlag = true;
        
        UniLog.log1("HAHA1");
        encryptFile(outFileName, fileName, passphase.toCharArray(), armorFlag, integrityCheckFlag);
        UniLog.log1("HAHA2");

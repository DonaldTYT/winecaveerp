...
public class RSAKeyPairGenerator
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        FileOutputStream secOut = new FileOutputStream("/tmp/axatest-pri.asc");
        FileOutputStream pubOut = new FileOutputStream("/tmp/axatest-pub.asc");
        String identity = "id001";
        String passphrase = "pass001";
        boolean armorFlag = true;
        UniLog.log1("before genkey");
        exportKeyPair(secOut, pubOut, kp, identity, passphrase.toCharArray(), armorFlag);
        UniLog.log1("after genkey");

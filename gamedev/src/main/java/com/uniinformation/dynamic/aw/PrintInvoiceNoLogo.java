...
public class PrintInvoiceNoLogo extends PrintMultiDoc {

public PrintInvoiceNoLogo() {
	
	super(null);
}
public PrintInvoiceNoLogo(ZkBiComposerBase p_bibase) {
	super(p_bibase);
}
...
protected void printOneDoc() throws Exception {
    ...
    /*
	ppj.addHeaderField("doctitle","Invoice",0,0);

...
public class PrintOldQuotation  extends BiActionHandler implements JxActionListener {

	public PrintOldQuotation() {
		super(null);
		// TODO Auto-generated constructor stub
	}
	public PrintOldQuotation(ZkBiComposerBase p_bibase) {
		super(p_bibase);
		// TODO Auto-generated constructor stub
	}
	...
	public void actionPerformed(JxField field) {
		...
		val = rpc.callSegment("artway_print_quotation",
					new VectorUtil()
					.addElement(invrg)
					.addElement("CHNPRINT")
					.addElement("VARIABLE")
		...
		if(val != null && val.toString().startsWith("OK")) {
			...
			UniLog.log("Print quotation got " + fname);
			try {
...
//			)k";
	...
	public boolean isDisabled(BiResult p_br,boolean p_isBatch) {
		...
		if(p_isBatch) {
			...
			if(!p_br.getSessionHelper().hasAccessRight("#prtoquo")) {
				return(true);
			}

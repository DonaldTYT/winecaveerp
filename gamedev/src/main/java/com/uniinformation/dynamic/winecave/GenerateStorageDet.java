...
public class GenerateStorageDet extends BiActionHandler implements JxActionListener {
	public GenerateStorageDet() {
		super(null);
	}
	public GenerateStorageDet(ZkBiComposerBase p_bibase) {
		super(p_bibase);
	}

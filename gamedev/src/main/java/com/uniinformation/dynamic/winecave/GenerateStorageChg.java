...
public class GenerateStorageChg extends BiActionHandler implements JxActionListener {
	private ZkBiAiAgentContext aiAgentContext;

	public GenerateStorageChg() {
		super(null);
	}
	public GenerateStorageChg(ZkBiComposerBase p_bibase) {
		super(p_bibase);
	}

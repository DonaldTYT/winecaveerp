...
public class VerifyStorageDet extends BiActionHandler implements JxActionListener {

	BiResultStorageChg br;

	public VerifyStorageDet(ZkBiComposerBase p_bibase) {
		super(p_bibase);
	...
	public ReturnMsg processAction(BiResult p_br,int p_idx) {
		...
		try {
			List<String> errList = br.regen_storagedet_verify_only();

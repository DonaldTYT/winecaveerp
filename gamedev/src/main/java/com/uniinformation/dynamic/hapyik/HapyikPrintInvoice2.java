...
public class HapyikPrintInvoice2 extends PrtdocClass  {
	BiResultQuotation br;
    PrtdocJson ppj;
    int docCnt;
    String cocode;
	public HapyikPrintInvoice2 (BiResultQuotation p_br) throws Exception {
    	String dnDoc = "HYINV02";
...
//    	ppj.addPageNo("page", "%s of %s",0, 0, 0);
    	ppj.addHeaderImage("logo", "logo/hapyic/hapyik_invoice.png",0,0,0,0);
    	ppj.addHeaderField("cvname", br.getCellString("vd_vname"));
    	ppj.addHeaderField("cvaddr", br.getCellString("inv_addr1"),0,0);
    	ppj.addHeaderField("cvaddr", br.getCellString("inv_addr2"),170,0);
    	ppj.addHeaderField("cvaddr", br.getCellString("inv_addr0"),0,35);
    	ppj.addHeaderField("cvaddr", br.getCellString("inv_tel"),0,70);
//    	ppj.addHeaderField("cvaddr", br.getCellString("inv_remark"),170,70);
    	ppj.addHeaderField("barcode", br.getCellString("inv_invno"),300,50);
    	ppj.addHeaderField("dfvalue", br.getCellString("inv_invno"),0,0);
    	ppj.addHeaderField("dfvalue", br.getCellString("vd_vcode"),0,20);
    	ppj.addHeaderField("dfvalue", br.getCellString("sm_name"),0,40);
    	ppj.addHeaderField("dfvalue", DateUtil.toDateString(br.getCellDate("inv_date"),"dd-mm-yyyy"),0,60);
    	ppj.addHeaderField("dfvalue", DateUtil.toDateString(br.getCellDate("inv_delidate"),"dd-mm-yyyy"),0,80);
    	...
    	ppj.addHeaderField("val_remark", br.getCellString("inv_remark"),0,0);
        ...
        ppj.addBottomField("timestr", "列印時間: "+tstr, 100,0);
        ppj.addBottomField("timestr", "星期天休息",280,0);
        ppj.addBottomField("val_remark", br.getCellString("inv_remark"),0,0);
		String addr;
    	...
    	ppj.addDetailHeaderField("hdr_description", "貨名/規格",0,0);
    	ppj.addDetailHeaderField("hdr_description", "Description/Packing",0,15);
        */
...
//            			ppj.addDetailRecordField("standard",c.getCellString("ind_comboqty"));
            		}
            }
			ppj.addDetailRecordField("price", c.getCell(indPrefix+"uprice").getColumnDisplayString()+"/"+c.getCell(indPrefix+"unit").getString() , 0, 0);
            if (c.getCell("ind_discpercent").getInt() != 0) {

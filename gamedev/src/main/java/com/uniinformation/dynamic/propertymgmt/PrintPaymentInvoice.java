...
public class PrintPaymentInvoice extends BatchPrtdocHandler {
	...
	public PrintPaymentInvoice(ZkBiComposerBase p_bibase) {
		super(p_bibase);
		// TODO Auto-generated constructor stub
	}
	...
	public void print() throws Exception {
    	...
    	ppj.addHeaderField("noBValue", br.getCellString("col_b") + (printCnt > 1 ? "R" : ""));
...
//    	ppj.addHeaderField("noValue", br.getCellString("col_a") , 0, 62);
    	...
    	ppj.addHeaderField("cvname", "聯絡人Contact:",-45,-50);
    	if(pmContact != null) {
    		ppj.addHeaderField("cvname", pmContact,55,-50);
    	}
//    	ppj.addHeaderField("noValue", br.getCellString("ppm_name"), 0, 82);
		...
		if (v1 != null)
			...
			*/
		String ss = MoneyToChinese.convertMoneyToWord(actualFee);
 		ppj.addBottomField("bottomLeft9f", "交來澳門元" + ss);
// 		ppj.addBottomField("bottomLeft9f", "0123456789叁三0123456789");
		if (v2 != null)

...
public class PrintParkingTmpLocPaymentInvoiceA5 extends PrintParkingTmpLocPaymentInvoice {

	public PrintParkingTmpLocPaymentInvoiceA5() {
		this(null);
	}

	public PrintParkingTmpLocPaymentInvoiceA5(ZkBiComposerBase p_bibase) {
		super(p_bibase);

...
public class PrtdocPrintQuotationCn extends PrtdocClass {
	BiResultQuotation br;
    PrtdocJson ppj;
    String cocode;

	public PrtdocPrintQuotationCn(BiResultQuotation p_br) throws Exception {
		br = p_br;
	...
	public void print() throws Exception {
    	...
    	case "AQM":
    		UniLog.log("print Quotation AQM");
    		break;
    	case "AQP":
    		UniLog.log("print Quotation AQP");
    		break;
    	}

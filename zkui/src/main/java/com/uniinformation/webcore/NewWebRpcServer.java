...
public class NewWebRpcServer extends RpcServer {
	public static NewWebRpcServer currentWebRpcServer = null;
	static SessionHelper sh;
	public NewWebRpcServer(int p_port,InputStream p_is) {
		super(p_port);
	/*
	...
	public static void startWebRpcServer(int p_port,InputStream p_classlist,SessionHelper p_sh)
	{
		if(currentWebRpcServer != null) {
			...
			currentWebRpcServer = new NewWebRpcServer(p_port,p_classlist);
		}
	}

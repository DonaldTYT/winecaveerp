...
public class ScpResultSet implements ResultSet {
...
//	 ScpResultSetMetaData metadata;
	 ...
	 */
	 public ScpResultSet(ScpStatement p_stmt) {
	 	scpstatement = p_stmt;
//		metadata = new ScpResultSetMetaData(this);
	 }
    public boolean next() throws SQLException {
		currrow = scpstatement.Scorpion_fetchstmt();
		if(currrow == null) return(false); else return(true);
	 }
    ...
    public byte getByte(int columnIndex) throws SQLException {
		...
		if(currrow.get(columnIndex-1) == null) return(0);
    ...
    public long getLong(int columnIndex) throws SQLException {
		...
		if(currrow.get(columnIndex-1) == null) return(0L);
    ...
    public float getFloat(int columnIndex) throws SQLException {
		...
		if(currrow.get(columnIndex-1) == null) return(0.0f);
    ...
    public double getDouble(int columnIndex) throws SQLException {
		...
		if(currrow.get(columnIndex-1) == null) return(0.0);

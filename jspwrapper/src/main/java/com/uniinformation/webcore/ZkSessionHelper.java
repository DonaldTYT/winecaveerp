...
public class ZkSessionHelper extends ZkossSessionHelper {
	/***
...
//	}
	public static ZkSessionHelper getSessionHelperDummy(String p_iniAgent,String p_loginid,ServletContext p_svc) {
		return SessionHelper.getSessionHelperDummy(p_iniAgent, p_loginid, p_svc, () -> new ZkSessionHelper());
	}
	/***
	...
	public static ZkSessionHelper getSessionHelper() {
		...
		SessionHelper sp = ZkossSessionHelper.getSessionHelper();
    	return ((ZkSessionHelper) sp);
	}

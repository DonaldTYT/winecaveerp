...
import com.uniinformation.itext.text.pdf.qrcode.QRCodeWriter;
...
public class BarcodeQRCode {
	...
	public byte[] createBarcode(int imageType, Color foreground, Color background) throws Exception {
        int width = bm.getWidth();
        int height = bm.getHeight();
		java.awt.Image image = createAwtImage(foreground, background);

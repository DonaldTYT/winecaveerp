...
public class BiResultCostAsAtXXNotUse extends BiResultErpv4 {
	...
	public BiResultCostAsAtXXNotUse(BiResult p_parent, BiView p_view, SelectUtil p_su, Vector p_tabList, String p_whereStr,

...
public class BiResultWineCave extends BiResultErpv4 {

	public BiResultWineCave(BiResult p_parent, BiView p_view, SelectUtil p_su, Vector p_tabList, String p_whereStr,

...
public class BiResultAdjustment extends BiResultStmov {

	public BiResultAdjustment(BiResult p_parent, BiView p_view, SelectUtil p_su, Vector p_tabList, String p_whereStr,

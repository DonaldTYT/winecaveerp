...
public class BiResultStockStatus extends BiResult {
	public BiResultStockStatus(BiResult p_parent,BiView p_view,SelectUtil p_su,Vector p_tabList, String p_whereStr, SessionHelper p_sh) throws CellException
	{

...
/* RANGE = ([a-zA-Z][a-zA-Z0-9_]*\!)?\$?[A-Za-z]+\$?[0-9]+:\$?[A-Za-z]+\$?[0-9]+ | \'[a-zA-Z][a-zA-Z0-9_ ]*\'!\$?[A-Za-z]+\$?[0-9]+:\$?[A-Za-z]+\$?[0-9]+ */
/* RANGE = (\'[a-zA-Z][a-zA-Z0-9_ ]*\')?([a-zA-Z][a-zA-Z0-9_]*\!)?\$?[A-Za-z]+\$?[0-9]+:\$?[A-Za-z]+\$?[0-9]+ */
RANGE = ([a-zA-Z][a-zA-Z0-9_\-]*\!)?\$?[A-Za-z]+\$?[0-9]*:\$?[A-Za-z]+\$?[0-9]* | (\'[a-zA-Z][a-zA-Z0-9_\- ]*\'\!)?\$?[A-Za-z]+\$?[0-9]*:\$?[A-Za-z]+\$?[0-9]*
CELL  = ([a-zA-Z][a-zA-Z0-9_\-]*\!)?\$?[A-Za-z]+\$?[0-9]+ | (\'[a-zA-Z][a-zA-Z0-9_\- ]*\'\!)?\$?[A-Za-z]+\$?[0-9]+
/* CELL  = ([a-zA-Z][a-zA-Z0-9_]*\!)?\$?[A-Za-z]+\$?[0-9]+ | \'[a-zA-Z][a-zA-Z0-9_ ]*\'!\$?[A-Za-z]+\$?[0-9]+ */
/* CELL  = \$?[A-Za-z]+\$?[0-9]+*/
INT = [0-9]+
NUM = (\.[0-9]+|[0-9]+\.[0-9]*)

...
public class ReturnMsg {
	...
	public boolean getStatus(){
		if (statusFlag == null){
			CoreLog.log("statusFlag is null, assume false");
			return(false);
		}
	...
	public int getStatusCode(){
		if (statusCode == null){
			CoreLog.log("statusCode is null, assume -1");
			return(-1);
		}
	...
	public String getMsg(){
		if (msg == null){
			CoreLog.log("msg is null, assume empty");
			return("");
		}
		else{
			return(msg);
	...
	public static void main(String args[]){
		...
		if ((rtnMsg = new ReturnMsg(false,123,"ok")).getStatus()){
			CoreLog.log(String.format("true %s", rtnMsg.getMsg()));
		}
		else{
			CoreLog.log(String.format("false %s", rtnMsg.getMsg()));
		}
		CoreLog.log("" + rtnMsg);
	}

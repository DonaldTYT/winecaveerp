...
public class ValueUtil {
   public static int intValue(Object p_obj) {
	    if (p_obj instanceof Float)
		 ...
		 CoreLog.log(new Exception("invalid object type intValue("+p_obj.getClass().getName()+")"));
	    return(0);
	}
   public static long longValue(Object p_obj) {
	    if (p_obj instanceof Float)
		 ...
		 CoreLog.log(new Exception("invalid object type longValue("+p_obj.getClass().getName()+")"));
	    return(0);
	}
   public static float floatValue(Object p_obj) {
	    if (p_obj instanceof Float)
		 ...
		 CoreLog.log(new Exception("invalid object type floatValue("+p_obj.getClass().getName()+")"));
	    return(0);
	}
   public static double doubleValue(Object p_obj) {
	    if (p_obj instanceof Float)
		 ...
		 CoreLog.log(new Exception("invalid object type doubleValue("+p_obj.getClass().getName()+")"));
	    return(0);
	}
   public static String stringValue(Object p_obj) {
	    if (p_obj instanceof Float)
		    ...
		    return((String) p_obj);
		 CoreLog.log(new Exception("invalid object type toString("+p_obj.getClass().getName()+")"));
	    return(null);
	}
}
